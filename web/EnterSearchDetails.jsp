...
<html lang="en">
  ...
  --%>
	...
	<body>
		...
		<div class="container">
                    <h1 class="well"><center>Enter Details For Searching Record</center></h1>
  ...
  <div class="col-md-2">
      <input type="text" id="tsub" name="tsub" class="form-control" required="" >
  </div>
      <label class="col-md-2 control-label" >Practical Subjects</label>
  <div class="col-md-2">
      <input type="text" id="psub" name="psub" class="form-control" required="" >
  </div>
