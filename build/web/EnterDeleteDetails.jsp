...
<html lang="en">
  ...
  <div class="col-md-2">
      <input type="text" id="rnofrom" name="rnofrom" class="form-control" required="" maxlength="12"  pattern="[A-Za-z0-9]{12}" title="Please enter right enrollment number" maxlength="2">
  </div>
      <label class="col-md-2 control-label" >To</label>
  <div class="col-md-2">
    <input type="text" id="rnoto" name="rnoto" class="form-control" required="" maxlength="12" pattern="[A-Za-z0-9]{12}" title="Please enter right enrollment number">
  </div>
