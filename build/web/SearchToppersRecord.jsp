    ...
    <br><br>
				<div class="widget-header">
					<i class="icon-th-list"></i>
                                        <h3><strong>Class Toppers</strong></h3>
				</div> <!-- /widget-header -->
        ...
        <%
          ...
          String top=request.getParameter("top").toString();
          String session1=request.getParameter("session").toString();
          ...
          if(type==1)
          {
           myresultlist=rd.searchSemesterToppers(branch,semester,top,session1);
          }
          else
          {
           myresultlist=rd.searchBranchToppers(branch,semester,top,session1);
          }
